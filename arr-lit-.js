...
let b=["hello","world"]
let newarr1=b.map(function(array){
...
let c =[1,2,3,4,5]
let newarr2=a.filter(function(value,index,array){
    return value%2==0;
})
console.log(newarr2)
...
let r=[1,2,3,4,5]
let s=r.findIndex(function(value,index){
    return index
})
console.log(s)
